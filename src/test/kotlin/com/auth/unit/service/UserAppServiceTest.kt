        ...
        describe("사용자 애플리케이션 서비스는") {
            ...
            context("ID로 사용자 조회 시") {
                ...
                it("존재하지 않는 사용자일 경우 null을 반환해야 한다") {
                    ...
                    every { userDomainService.findUserById(nonExistentId) } throws
                        NoSuchElementException("사용자를 찾을 수 없습니다 : userId - $nonExistentId")
            ...
            context("이메일로 사용자 조회 시") {
                ...
                it("존재하지 않는 사용자 이메일일 경우 NoSuchElementException 을 발생시켜야 한다") {
                    ...
                    every {
                        userDomainService.findUserByEmail(
                            nonExistentEmailObject,
                        )
                    } throws NoSuchElementException("사용자를 찾을 수 없습니다 : email - $email")
